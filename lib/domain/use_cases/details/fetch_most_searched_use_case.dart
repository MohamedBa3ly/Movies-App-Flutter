...
class FetchMostSearchResultUseCase extends UseCase<List<MovieHomeEntity>, NoParam> {
  final MovieRepository movieRepository;
  FetchMostSearchResultUseCase(this.movieRepository);

  @override
  Future<Either<Failure, List<MovieHomeEntity>>> call([NoParam? param]) async {
    return await movieRepository.fetchMostSearched();
  }
