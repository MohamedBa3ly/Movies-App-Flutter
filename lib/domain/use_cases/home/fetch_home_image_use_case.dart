...
class FetchHomeImageUseCase extends UseCase<List<MovieHomeEntity>, NoParam> {
  final MovieRepository movieRepository;
  FetchHomeImageUseCase(this.movieRepository);

  @override
  Future<Either<Failure, List<MovieHomeEntity>>> call([NoParam? param]) async {
    return await movieRepository.fetchHomeImage();
  }
